...
#userName,#conBox{color:#777;border:1px solid #d0d0d0;border-radius:6px;background:rgba(255,255,255,0.8) url(img/inputBG.png) repeat-x;padding:3px 5px;font:14px/1.5 arial;}
...
#msgBox .list h3{position:relative;height:33px;font-size:14px;font-weight:400;background:#e3eaec;opacity:0.8;border:1px solid #dee4e7;}
#msgBox .list h3 span{position:absolute;left:6px;top:6px;background:#fff;opacity:0.8;line-height:28px;display:inline-block;padding:0 15px;}
#msgBox .list ul{overflow:hidden;zoom:1;}
#msgBox .list ul li{float:left;clear:both;width:100%;border-bottom:1px dashed #d8d8d8;padding:10px 0;background:#fff;opacity:0.8;overflow:hidden;}
#msgBox .list ul li.hover{background:#f5f5f5;opacity:0.8;}
    ...
    <form action="/sn/liu/save" method="post">
        ...
        <div class="tr">
            <p>
                ...
                <input id="sendBtn" type="submit" value="点击留言"  />
            </p>
        </div>
    </form>
    <div class="list">
